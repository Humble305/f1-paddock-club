...
let currentGroupDateDrivers = [];
let currentGroupDateScene = null;
let currentGroupDateRound = 0;
let groupDateMessages = [];
let groupDateInProgress = false;
let currentGroupDateEvent = null;
let groupDateEventHistory = [];
let groupDateEventCooldown = 0;
let groupDateMemories = {};
let groupDateSessions = {};
