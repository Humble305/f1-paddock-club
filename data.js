...
const ANNOUNCEMENTS_UI = [
    { version: "v4.3.0", content: "群聊资料页升级 & 联系人列表重构\n• 每位车手现在都有更明确的好感话题权重：最爱、一般感兴趣、基本无感三层分开计算，不再是随便夸几句就能轻松涨好感；聊到对味的话题、问得更具体时，加分也会更明显\n• 群聊回复逻辑继续细化：会优先看你有没有点名、谁对当前话题更有兴趣、谁和你更熟，再决定谁来接话，整体更像真实小群而不是随机轮流发言\n• 群聊资料卡升级为更完整的 IM 风格：新增群公告、成员搜索、已选成员展示、群状态统计、置顶与免打扰开关，编辑群资料时也更接近 QQ / 微信的群资料页体验\n• 左侧联系人列表重构：群聊模块下方新增独立的「置顶联系人」区域，星标车手会固定汇总到最上方，不再只是藏在各车队分组里靠前排序\n• 所有车队分组现在都支持和群聊一样的折叠收纳，联系人列表更清爽，长列表浏览时也更容易整理出自己的常用聊天入口\n• 群聊卡片的成员小头像预览已移除，视觉更干净，信息层次也更统一" },
