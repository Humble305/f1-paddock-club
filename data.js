...
window.ANNOUNCEMENTS = [
    ...
    {
        version: "v4.2.0",
        content: "围场动态升级 & 比赛周事件系统接入\n- 围场动态重做成更像真人社媒的公开主页流，车手发帖、互评和公开回复都更贴近本人语气，也更贴近现实围场关系\n- 车手之间的互动逻辑进一步细化：熟人更容易评论，关系一般的更多只会点赞，动态下方也加入了可见的点赞列表\n- 比赛周事件系统正式接入，聊天、动态和赛历会一起根据当前分站与比赛周阶段变化，围场氛围不再是静态背景\n- 单人聊天新增比赛周专属快捷互动入口，不同阶段会出现更贴当前节奏的话题切口，让对话更像真的发生在这个比赛周里"
    },
    ...(window.ANNOUNCEMENTS || []).filter(item => !['v4.5.0', 'v4.4.0', 'v4.3.0', 'v4.2.0'].includes(item?.version))
];
